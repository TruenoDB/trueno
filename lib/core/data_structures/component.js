...
class Component {
  ...
  set computed(value) {
    this.mark('computed');
    this._property._computed = value;
  }

  set attributes(value) {
    this.mark('attributes');
    this._property._attributes = value;
  }
  ...
  getComputedAlgorithm(algo) {
    ...
    /* getting the attribute */
    return Object.freeze(this._property._computed[algo]);
  }
  ...
  removeComputedAlgorithm(algo) {
    ...
    /* removing the attribute */
    delete this._property._computed[algo];
  }
  ...
  setComputedAttribute(algo, attr, value) {
    ...
    /* Adding the attribute */
    this._property._computed[algo][attr] = value;
  ...
  getComputedAttribute(algo, attr) {
    ...
    /* Getting the attribute */
    return this._property._computed[algo][attr];
  ...
  removeComputedAttribute(algo, attr) {
    ...
    /* removing the attribute */
    delete this._property._computed[algo][attr];
  }
