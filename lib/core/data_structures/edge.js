...
class Edge extends Component {
  ...
  constructor(param = {}) {
    ...
    this._property._from = param.from || null;
    /* The destination vertex id of the edge */
    this._property._to = param.to || null;
    ...
    this.setMapping('fromv', 'from');
    this.setMapping('tov', 'to');
  ...
  get from() {
    return this._property._from;
  }

  get to() {
    return this._property._to;
  }
  ...
  set from(value) {
    this._property._from = value;
  }

  set to(value) {
    this._property._to = value;
  }
