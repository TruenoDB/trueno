...
class Search {
  ...
  search(f, index, type, filterPrebuilded) {
    ...
    return new Promise((resolve, reject)=> {
      ...
      // console.log('--debuggy-- f: ', f, ' index: ', index, ' type: ', type, ' filterPrebuilded: ', filterPrebuilded);
      // console.log('--debuggy-- q: ', q);
      ...
      self._client.search(q).then((response)=> {
        // console.log('--debugy-- elasticsearch.search response: ', response.hits.hits);
        ...
        // console.log('--debugy-- elasticsearch.search error: ', error);
        reject(error);
      });
    });
  }
  ...
  _buildQueryFilter(f, index, type, prebuilded) {
    ...
    // console.log('--debuggy-- f.build(): ', f.build());
