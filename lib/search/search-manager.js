...
class SearchManager {
  ...
  constructor(param = {}) {
    ...
    this._port = param.port || global.config.components.elasticsearch.cmdFlags[1];
      ...
      switch (e.op) {
        case 'ex_persist':
          ...
          if (e.content.obj.id) {
            ...
            delete e.content.obj.id;
          } else if (e.content.obj.hasOwnProperty('id')) {
            delete e.content.obj.id;
          }
          /* adding meta */
