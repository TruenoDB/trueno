    ...
    switch (job.algorithmType) {
      ...
      case Enums.algorithmType.PAGE_RANK:
        ...
        let pagerankParameters = job.parameters;
            ...
            pagerankParameters.comp      = Enums.parameters.compute;
        ...
        self._objAlgorithms.run(pagerankParameters).then(function (jobId) {
...
ComputeScheduler.prototype._ex_computeJobResult = function(jobId) {
  ...
  return new Promise( function(resolve, reject) {
    ...
    resolve(self._objAlgorithms._ex_jobResultRequest(jobId));
