 ...
 *
 */
function LocalComputer(options, graphLabResultsCtrl) {
 ...
 */
LocalComputer.prototype.compute = function (algoName, algoFn, params) {
  ...
  jsnx['gen' + algoFn.charAt(0).toUpperCase() + algoFn.slice(1)](this._g)
