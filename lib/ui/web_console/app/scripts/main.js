...
webConsole.prototype.init = function () {
  ...
  panel.controller("cerebroCtrl", ['$scope', '$sce',
    function ($scope, $sce) {
      self._cerebroCtrl = new Cerebro({scope: $scope, sce: $sce, wConsole: self});
      self._cerebroCtrl.init();
      console.log('ElasticSearch Controller Initialized');
    }]);
  /* Initialize Indexing controller */
