...
class TruenoSessionFactory {
  ...
  static connect(param = {}) {
    ...
    conn = new connection({hosts:[global.config.components.cassandra.configFlags.listen_address +':'+global.config.components.cassandra.configFlags.native_transport_port]});
