...
class TruenoStorageManager {
  ...
  castObj(o) {
    ...
    logger.info('= casting object: ======backend manager [1]')
    console.log(o);
    ...
    logger.info('= casting object: ======backend manager [2]')
    console.log(obj);
  ...
  persist(obj, idx, type) {
    ...
    /* logging */
    console.log('[storage-manager] persist', o);
  ...
  destroy(obj, idx, type) {
    ...
    /* logging */
    console.log('[storage-manager] destroy', o);
    logger.debug('[storage-manager] destroy', o);
  ...
  // FIXME: This seems like an unnecesarry overhead in the communications. To retrieve the component only the ID should be needed.
  /**
  ...
  fetch_one(g, obj, type) {
    ...
    console.log('retrieving ', type, ' id: ', obj._property._id);
