...
class TruenoGraphSimple {
  ...
  removeVertex(vertex) {
    ...
    return new Promise((resolve, reject) => {
      ...
      self._conn.execute(q.build(Components.VERTEX, Operations.DELETE,
        {
          keyspace : vertex._property._graphid,
          node     : vertex._property._id
        })).then( result => {
        resolve();
      }).catch( e => {
  ...
  removeEdge(edge) {
    ...
    return new Promise((resolve, reject) => {
      ...
      self._conn.execute(q.build(Components.EDGE, Operations.DELETE,
        {
          keyspace : edge._property._graphid,
          fromid   : edge._property._from,
          toid     : edge._property._to
        })).then( result => {
        resolve();
      }).catch( e => {
  ...
  getVertex(vertex) {
    ...
    return new Promise((resolve, reject) => {
      ...
      self._conn.execute(q.build(Components.VERTEX, Operations.GET,
        {
          keyspace : self._name,
