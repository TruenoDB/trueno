...
/* creating connection */
var conn = new Connection({hosts:[global.config.components.cassandra.configFlags.listen_address +':'+global.config.components.cassandra.configFlags.native_transport_port]});
/* Connect */
