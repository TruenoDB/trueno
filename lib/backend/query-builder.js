...
class QueryBuilder {
  ...
  constructor() {
    ...
    /* graph */
    this._graph = {
      get: _.template(fs.readFileSync(templateIndex.graph.get)),
    ...
    /* vertex */
    this._vertex = {
      get: _.template(fs.readFileSync(templateIndex.vertex.get)),
    ...
    /* edge */
    this._edge = {
      get: _.template(fs.readFileSync(templateIndex.edge.get)),
